                ...
                <div id="abc" class="col-md-4">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <button onclick="redirigerVersFormulaire('./add_candidature_entreprise.php')">Recrutement</button>
                            <button onclick="redirigerVersFormulaire('./candidature.php')">Demande de
                                candidature</button>
