...
@endforeach
            ...
            <div class="card-body">
                <form action="{{ route('addcandidature') }}" method="POST" enctype="multipart/form-data" id="add-form">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="fichier"  id="fichier" accept=".pdf,.doc,.docx" class="form-control-file" required>
                    </div>
